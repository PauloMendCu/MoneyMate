...
public class NuevoMovimientoActivity extends AppCompatActivity {
    ...
    private void cargarDatosLocales() {
        executorService.execute(() -> {
            ...
            runOnUiThread(() -> {
                List<Categoria> testCategorias = db.categoriaDao().getAllByUser(userId);
                Log.d("TestCategorias", "Categorías: " + testCategorias.toString());
            });
        });
    }
    ...
    private class LoadDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            Log.d("LoadDataAsyncTask", "UserId: " + userId);

            // Log para verificar si las categorías están siendo obtenidas correctamente
            Log.d("LoadDataAsyncTask", "Categorías obtenidas: " + categorias.toString());

            if (cuentas == null || categorias == null) {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            // Debugging
            Log.d("LoadDataAsyncTask", "Cuentas: " + cuentas.toString());
            Log.d("LoadDataAsyncTask", "Categorías: " + categorias.toString());
        }
    }
